/* AMPERE ELECTRIC — SEARCH DATA */

const AMPERE_SEARCH_DATA = [

  /* HOME */
  {
  title: "Ampere Electric",
  category: "Home",
  keywords: "ampere electric pune industrial electrical solutions motors generators transformers control panels switchgear ev charging earthing cooling tower",
  url: "index.html"
  },
  ...
  /* PRODUCTS */
  {
    title: "Products",
    category: "Products",
    keywords: "electrical products ht lt motors marathon siemens cg power bharat bijlee diesel generators sterling transformers control panels megavolt power switchgear cables electric drives l&t danfoss schneider yaskawa ev charging earthing cooling tower",
    url: "products.html"
  },
  {
    title: "Electric Drives",
    category: "Products",
    keywords: "electric drives vfd variable frequency drive l&t danfoss schneider yaskawa motor speed control automation",
    url: "products.html"
  },
   {
     title: "Transformers",
     category: "Products",
     keywords: "transformers distribution transformers industrial transformers megavolt power llp electrical power",
     url: "products.html"
   },
   {
     title: "Diesel Generators",
     category: "Products",
     keywords: "diesel generators dg sets sterling industrial generator backup power",
     url: "products.html"
   },
  {
    title: "IE4 Motors",
    category: "Products",
    keywords: "ie4 motors premium efficiency motor cg power siemens bharat bijlee",
    url: "product-details.html?product=ie4-motors"
  },
  {
    title: "IE3 Motors",
    category: "Products",
    keywords: "ie3 motors energy efficient industrial motors",
    url: "product-details.html?product=ie3-motors"
  },
  {
    title: "IE2 Motors",
    category: "Products",
    keywords: "ie2 motors pumps fans conveyors industrial motor",
  ...
  /* DOWNLOADS */
  {
    title: "Downloads",
    category: "Downloads",
    keywords: "catalogue datasheet brochure company profile pdf downloads",
    url: "downloads.html"
  },
  ...
  /* CONTACT */
  {
    title: "Contact Ampere Electric",
    category: "Contact",
    keywords: "contact quote enquiry whatsapp phone email pune",
    url: "contact.html"
  }
];